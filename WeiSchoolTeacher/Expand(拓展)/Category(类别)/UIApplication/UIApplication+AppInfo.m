...
-(UIViewController *)getCurrentViewConttoller
{
   // UIViewController *vc=nil;
    ...
    if ([topController isKindOfClass:[MainViewController class]]) {
        MainTabBarController *mainVC=((MainViewController *)topController).mainTabBarController;
       UINavigationController *nav = (UINavigationController *) mainVC.viewControllers[mainVC.selectedIndex];
