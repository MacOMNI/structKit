...
@implementation NSObject (MacSwipeView)

- (CGSize)swipeViewItemSize:(__unused MacSwipeView *)swipeView { return CGSizeZero; }
- (void)swipeViewDidScroll:(__unused MacSwipeView *)swipeView {}
- (void)swipeViewCurrentItemIndexDidChange:(__unused MacSwipeView *)swipeView {}
- (void)swipeViewWillBeginDragging:(__unused MacSwipeView *)swipeView {}
- (void)swipeViewDidEndDragging:(__unused MacSwipeView *)swipeView willDecelerate:(__unused BOOL)decelerate {}
- (void)swipeViewWillBeginDecelerating:(__unused MacSwipeView *)swipeView {}
- (void)swipeViewDidEndDecelerating:(__unused MacSwipeView *)swipeView {}
- (void)swipeViewDidEndScrollingAnimation:(__unused MacSwipeView *)swipeView {}
- (BOOL)swipeView:(__unused MacSwipeView *)swipeView shouldSelectItemAtIndex:(__unused NSInteger)index { return YES; }
- (void)swipeView:(__unused MacSwipeView *)swipeView didSelectItemAtIndex:(__unused NSInteger)index {}

@end


@interface MacSwipeView () <UIScrollViewDelegate, UIGestureRecognizerDelegate>
